...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Agencies list")); ?></h1>
            <div class="title-actions">
                <a href="<?php echo e(route('agencies.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new agency")); ?></a>
            </div>
        </div>
        <?php echo $__env->make('admin.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <form method="post" action="<?php echo e(url('admin/module/agencies/bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(url('/admin/module/agencies')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                            ...
                            <?php if($rows->isNotEmpty()): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(url('admin/module/agencies/form/'.$row->id)); ?>"><?php echo e($row->name); ?></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a target="_blank" href="<?php echo e(url("/admin/module/review?service_id=".$row->id.'&service=agencies')); ?>" class="review-count-approved">
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('agencies.admin.create',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Edit')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\findhouse.2.1.0\themes/Findhouse/Agencies/Views/admin/agency/index.blade.php ENDPATH**/ ?>