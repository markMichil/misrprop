<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" class="form-control" placeholder="<?php echo e(__("Real address")); ?>" value="<?php echo e($translation->address); ?>">
        </div>
        <?php if(is_default_lang()): ?>
            <div class="form-group">
...
<?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\findhouse.2.1.0\themes/Findhouse/Property/Views/admin/property/location.blade.php ENDPATH**/ ?>