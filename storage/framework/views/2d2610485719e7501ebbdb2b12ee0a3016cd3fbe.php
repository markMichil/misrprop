...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Property Categories")); ?></h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('property.admin.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo $__env->make('Property::admin/category/form',['parents'=>$rows], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(route('property.admin.category.bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(url('/admin/module/property/category')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php if( count($rows) > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(url('admin/module/property/category/edit/'.$row->id)); ?>"><?php echo e($prefix.' '.$row->name); ?></a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\findhouse.2.1.0\themes/Findhouse/Property/Views/admin/category/index.blade.php ENDPATH**/ ?>