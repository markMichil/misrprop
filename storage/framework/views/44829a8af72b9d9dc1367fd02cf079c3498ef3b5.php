            ...
            <div class="container">
                <div class="row py-5">
                    <div class="col-md-12 col-lg-8">
                        <h3><?php echo e($translation->name); ?></h3>
                                ...
                                <?php if(view()->exists($view)): ?>
                                    <?php if($data[$type]->count()>0): ?>
                                        <div class="tab-pane <?php echo e($i==0?'active':""); ?>" id="module-<?php echo e($type); ?>">
                                            <?php echo $__env->make($view,['title'=>"",'style_list'=>'normal','desc'=>'','rows'=> $data[$type],'hide_scroll_down'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\findhouse.2.1.0\themes/Findhouse/Location/Views/frontend/detail.blade.php ENDPATH**/ ?>