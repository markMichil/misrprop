            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="text" class="form-control" name="page_contact_title" value="{{$settings['page_contact_title'] ?? '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="">{{__("Contact Sub Title")}}</label>
                        <div class="form-controls">
                            <input type="text" class="form-control" name="page_contact_sub_title" value="{{$settings['page_contact_sub_title'] ?? '' }}">
                        </div>
                    </div>
                </div>
            </div>
