            ...
            <div class="form-group">
                ...
                <div class="form-content">
                    ...
                    <div class="smart-search">
                        <input type="text" class="smart-select parent_text form-control" readonly placeholder="{{__("All :name",['name'=>$attr->name??''])}}" value="{{ $selected ?
                        $selected->name ?? '' :'' }}" data-default="{{ json_encode($list_cat_json) }}">
