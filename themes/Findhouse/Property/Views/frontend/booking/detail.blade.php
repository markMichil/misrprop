    ...
    <div class="booking-review-content">
        <div class="review-section">
            <div class="service-info">
                ...
                @if($vendor->hasPermission('dashboard_agent_access') and !$vendor->hasPermission('dashboard_access'))
                    <div class="mt-2">
                    ...
                    <ul class="review-list list-unstyled">
                            <li class="mb-3 pb-1 border-bottom">
                                <h6 class="label text-center font-weight-bold mb-1"></h6>
                                    <div>
                                        @includeIf("Property::frontend.booking.detail-date",['rows'=>$dateDetail])
                                    </div>
