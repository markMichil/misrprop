...
class CreatePropertyTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_properties', function (Blueprint $table) {
        ...
        Schema::create('bravo_property_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_property_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_property_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_properties');
        Schema::dropIfExists('bravo_property_translations');
        Schema::dropIfExists('bravo_property_term');
        Schema::dropIfExists('bravo_property_dates');
    }
}
